...
Pane {
    ...
    property var _baseunits: ['RIN','mRIN','bits','sat']
            ...
            Pane {
                ...
                GridLayout {
                            ...
                            if (activeFocus) {
                                if (Config.language != currentValue) {
                                    ...
                                    var dialog = app.messageDialog.createObject(app, {
                                        text: qsTr('Please restart Electrin to activate the new GUI settings')
                                    })
                                    dialog.open()
                                }
                            }
                    ...
                    RowLayout {
                        ...
                        Label {
                            Layout.fillWidth: true
                            text: qsTr('Add thousands separators to rincoin amounts')
                            wrapMode: Text.Wrap
                        }
                    }
                                ...
                                if (activeFocus) {
                                    if (!checked) {
                                        var dialog = app.messageDialog.createObject(app, {
                                            ...
                                            text: qsTr('Electrin will have to download the Lightning Network graph, which is not recommended on mobile.'),
                                            yesno: true
                                        })
